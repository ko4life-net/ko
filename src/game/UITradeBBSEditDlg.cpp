...
bool CUITradeBBSEditDlg::Load(HANDLE hFile) {
    ...
    m_pEditTitle = (CN3UIEdit *)(this->GetChildByID("edit_name"));
    __ASSERT(m_pEditTitle, "NULL UI Component!!!");
    m_pEditPrice = (CN3UIEdit *)(this->GetChildByID("edit_price"));
    __ASSERT(m_pEditPrice, "NULL UI Component!!!");
    m_pEditExplanation = (CN3UIEdit *)(this->GetChildByID("edit_memo"));
    __ASSERT(m_pEditExplanation, "NULL UI Component!!!");
    m_pBtn_Ok = (CN3UIButton *)(this->GetChildByID("btn_Ok"));
