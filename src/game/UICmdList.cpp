...
CUICmdListDlg::CUICmdListDlg() {
    ...
    m_pList_Cmds = NULL;
    m_pUICmdEdit = NULL;
    m_pScroll_Categories = NULL;
    m_pScroll_Commands = NULL;
}
...
bool CUICmdListDlg::Load(HANDLE hFile) {
    ...
    /*
    m_pScroll_Categories = (CN3UIList *)m_pList_CmdCat->GetChildByIndex(0);
    __ASSERT(m_pScroll_Categories, "NULL UI Component!!");
    m_pScroll_Categories->SetVisible(true);

    m_pScroll_Commands = (CN3UIScrollBar *)m_pList_Cmds->GetChildByIndex(0);
    __ASSERT(m_pScroll_Categories, "NULL UI Component!!");
