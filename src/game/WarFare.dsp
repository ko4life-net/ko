...
# ADD CPP /nologo /W3 /GX /O2 /Ob2 /I "...\vendor\DXSDK9\Include" /I "." /I "..\vendor\DXSDK9\Include" /I "..\engine" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_N3GAME" /D DIRECTINPUT_VERSION=0x0800 /Fr /YX"stdafx.h" /FD /c
...
# ADD LINK32 implode.lib kernel32.lib user32.lib gdi32.lib advapi32.lib shell32.lib winmm.lib imm32.lib ddraw.lib d3d9.lib d3dx9.lib dsound.lib dxguid.lib  wsock32.lib dinput8.lib ..\engine\JPEG\jpegLib.lib /nologo /version:0.1 /subsystem:windows /pdb:none /map /machine:I386 /out:"KnightOnLine.exe" /libpath:"..\vendor\DXSDK9\Lib\x86"
...
# ADD CPP /nologo /W3 /Gm /Gi /GX /ZI /Od /I "." /I "..\vendor\DXSDK9\Include" /I "..\engine" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_N3GAME" /D DIRECTINPUT_VERSION=0x0800 /Fr /YX"stdafx.h" /FD /GZ /c
...
# ADD LINK32 implode.lib winmm.lib imm32.lib ddraw.lib d3d9.lib d3dx9.lib dsound.lib dxguid.lib  wsock32.lib dinput8.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib NAFXCWD.LIB LIBCMTD.LIB ..\engine\JPEG\jpegLib.lib /nologo /subsystem:windows /profile /map /debug /machine:I386 /nodefaultlib:"msvcrt" /out:"KnightOnLine_Debug.exe" /libpath:"..\vendor\DXSDK9\Lib\x86"
