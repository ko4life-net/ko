...
bool CUITradeExplanation::Load(HANDLE hFile) {
    ...
    m_pBtn_PageUp = (CN3UIButton *)(this->GetChildByID("btn_pageup"));
    __ASSERT(m_pBtn_PageUp, "NULL UI Component!!!");
    m_pBtn_PageDown = (CN3UIButton *)(this->GetChildByID("btn_pagedown"));
    ...
    m_pText_Explanation = (CN3UIString *)(this->GetChildByID("Text_Title"));
    __ASSERT(m_pText_Explanation, "NULL UI Component!!!");
