...
bool CUIState::Load(HANDLE hFile) {
    ...
    m_pText_ID = (CN3UIString *)GetChildByID("Text_ID");
    __ASSERT(m_pText_ID, "NULL UI Component!!");
    m_pText_Level = (CN3UIString *)GetChildByID("Text_Level");
    __ASSERT(m_pText_Level, "NULL UI Component!!");
    m_pText_RealmPoint = (CN3UIString *)GetChildByID("Text_RealmPoint");
    __ASSERT(m_pText_RealmPoint, "NULL UI Component!!");

    m_pText_Class = (CN3UIString *)GetChildByID("Text_Class");
    __ASSERT(m_pText_Class, "NULL UI Component!!");
    m_pText_Race = (CN3UIString *)GetChildByID("Text_Race");
    __ASSERT(m_pText_Race, "NULL UI Component!!");
    m_pText_Nation = (CN3UIString *)GetChildByID("Text_Nation");
    __ASSERT(m_pText_Nation, "NULL UI Component!!");

    m_pText_HP = (CN3UIString *)GetChildByID("Text_HP");
    __ASSERT(m_pText_HP, "NULL UI Component!!");
    m_pText_MP = (CN3UIString *)GetChildByID("Text_MP");
    __ASSERT(m_pText_MP, "NULL UI Component!!");
    m_pText_Exp = (CN3UIString *)GetChildByID("Text_Exp");
    __ASSERT(m_pText_Exp, "NULL UI Component!!");
    m_pText_AP = (CN3UIString *)GetChildByID("Text_AP");
    __ASSERT(m_pText_AP, "NULL UI Component!!");
    m_pText_GP = (CN3UIString *)GetChildByID("Text_GP");
    __ASSERT(m_pText_GP, "NULL UI Component!!");
    m_pText_Weight = (CN3UIString *)GetChildByID("Text_Weight");
    __ASSERT(m_pText_Weight, "NULL UI Component!!");

    m_pText_BonusPoint = (CN3UIString *)GetChildByID("Text_BonusPoint");
    __ASSERT(m_pText_BonusPoint, "NULL UI Component!!");

    m_pBtn_Strength = (CN3UIButton *)GetChildByID("Btn_Strength");
    __ASSERT(m_pBtn_Strength, "NULL UI Component!!");
    m_pBtn_Stamina = (CN3UIButton *)GetChildByID("Btn_Stamina");
    __ASSERT(m_pBtn_Stamina, "NULL UI Component!!");
    m_pBtn_Dexterity = (CN3UIButton *)GetChildByID("Btn_Dexterity");
    __ASSERT(m_pBtn_Dexterity, "NULL UI Component!!");
    m_pBtn_MagicAttak = (CN3UIButton *)GetChildByID("Btn_MagicAttack");
    __ASSERT(m_pBtn_MagicAttak, "NULL UI Component!!");
    m_pBtn_Intelligence = (CN3UIButton *)GetChildByID("Btn_Intelligence");
    __ASSERT(m_pBtn_Intelligence, "NULL UI Component!!");

    m_pText_Strength = (CN3UIString *)GetChildByID("Text_Strength");
    __ASSERT(m_pText_Strength, "NULL UI Component!!");
    m_pText_Stamina = (CN3UIString *)GetChildByID("Text_Stamina");
    __ASSERT(m_pText_Stamina, "NULL UI Component!!");
    m_pText_Dexterity = (CN3UIString *)GetChildByID("Text_Dexterity");
    __ASSERT(m_pText_Dexterity, "NULL UI Component!!");
    m_pText_MagicAttak = (CN3UIString *)GetChildByID("Text_MagicAttack");
    __ASSERT(m_pText_MagicAttak, "NULL UI Component!!");
    m_pText_Intelligence = (CN3UIString *)GetChildByID("Text_Intelligence");
    __ASSERT(m_pText_Intelligence, "NULL UI Component!!");

    m_pText_RegistFire = (CN3UIString *)GetChildByID("Text_RegistFire");
    __ASSERT(m_pText_RegistFire, "NULL UI Component!!");
    m_pText_RegistMagic = (CN3UIString *)GetChildByID("Text_RegistMagic");
    __ASSERT(m_pText_RegistMagic, "NULL UI Component!!");
    m_pText_RegistIce = (CN3UIString *)GetChildByID("Text_RegistIce");
    __ASSERT(m_pText_RegistIce, "NULL UI Component!!");
    m_pText_RegistCurse = (CN3UIString *)GetChildByID("Text_RegistCurse");
    __ASSERT(m_pText_RegistCurse, "NULL UI Component!!");
    m_pText_RegistLight = (CN3UIString *)GetChildByID("Text_RegistLightR");
    __ASSERT(m_pText_RegistLight, "NULL UI Component!!");
    m_pText_RegistPoison = (CN3UIString *)GetChildByID("Text_RegistPoison");
    __ASSERT(m_pText_RegistPoison, "NULL UI Component!!");

    m_pImg_Str = GetChildByID("img_str");
    __ASSERT(m_pImg_Str, "NULL UI Component!!");
    m_pImg_Sta = GetChildByID("img_sta");
    __ASSERT(m_pImg_Sta, "NULL UI Component!!");
    m_pImg_Dex = GetChildByID("img_dex");
    __ASSERT(m_pImg_Dex, "NULL UI Component!!");
    m_pImg_Int = GetChildByID("img_int");
    __ASSERT(m_pImg_Int, "NULL UI Component!!");
    m_pImg_MAP = GetChildByID("img_map");
    __ASSERT(m_pImg_MAP, "NULL UI Component!!");
...
bool CUIKnights::Load(HANDLE hFile) {
    ...
    m_pText_Name = (CN3UIString *)this->GetChildByID("Text_ClansName");
    __ASSERT(m_pText_Name, "NULL UI Component!!");
    m_pText_Duty = (CN3UIString *)this->GetChildByID("Text_clan_Duty");
    __ASSERT(m_pText_Duty, "NULL UI Component!!");
    m_pText_Page = (CN3UIString *)this->GetChildByID("Text_clan_Page");
    ...
    m_pBtn_Appoint = (CN3UIButton *)(this->GetChildByID("btn_clan_Appoint"));
    __ASSERT(m_pBtn_Appoint, "NULL UI Component!!");
    m_pBtn_Remove = (CN3UIButton *)(this->GetChildByID("btn_clan_Remove"));
    __ASSERT(m_pBtn_Remove, "NULL UI Component!!");
...
void CUIKnights::UpdateKnightsDuty(e_KnightsDuty eDuty) {
    if (NULL == m_pText_Duty) {
        return;
    }
    std::string szDuty;
    switch (eDuty) {
    case KNIGHTS_DUTY_CHIEF:
        ::_LoadStringFromResource(IDS_KNIGHTS_DUTY_CHIEF, szDuty);
        break;
...
void CUIKnights::MemberListAdd(const std::string & szName, e_KnightsDuty eDuty, e_Class eClass, int iLevel,
                               int iConnected) {
...
bool CUIFriends::Load(HANDLE hFile) {
    ...
    m_pList_Friends = (CN3UIList *)this->GetChildByID("List_Friends");
    __ASSERT(m_pList_Friends, "NULL UI Component!!");
    m_pText_Page = (CN3UIString *)this->GetChildByID("String_Page");
    __ASSERT(m_pText_Page, "NULL UI Component!!");

    m_pBtn_NextPage = (CN3UIButton *)(this->GetChildByID("Btn_Page_Down"));
    __ASSERT(m_pBtn_NextPage, "NULL UI Component!!");
    m_pBtn_PrevPage = (CN3UIButton *)(this->GetChildByID("Btn_Page_Up"));
    __ASSERT(m_pBtn_PrevPage, "NULL UI Component!!");

    m_pBtn_Refresh = (CN3UIButton *)this->GetChildByID("Btn_Refresh");
    __ASSERT(m_pBtn_Refresh, "NULL UI Component!!");
    m_pBtn_Party = (CN3UIButton *)this->GetChildByID("Btn_Party");
    __ASSERT(m_pBtn_Party, "NULL UI Component!!");
    m_pBtn_Whisper = (CN3UIButton *)this->GetChildByID("Btn_Whisper");
    __ASSERT(m_pBtn_Whisper, "NULL UI Component!!");
    m_pBtn_Add = (CN3UIButton *)this->GetChildByID("Btn_Add");
    __ASSERT(m_pBtn_Add, "NULL UI Component!!");
    ...
    if (dwMsg == UIMSG_BUTTON_CLICK) {
        if (pSender == m_pBtn_PrevPage || pSender == m_pBtn_NextPage) {
            ...
            if (m_iPageCur < 0) {
                ...
                int iPageMax = 0;
                if (iLinePerPage > 0) {
                    iPageMax = (m_MapFriends.size() / iLinePerPage) + 1;
                }
...
void CUIFriends::MsgSend_MemberInfo(bool bDisableInterval) {
    ...
    CAPISocket::MP_AddByte(
        &(buffers[0]), iOffset,
        N3_FRIEND_INFO); // 친구 정보.. Send s1(이름길이), str1(유저이름) | Receive s1(이름길이), str1(유저이름), s1(ID), b2(접속, 파티)
...
void CUIFriends::MsgRecv_MemberInfo(DataPack * pDataPack, int & iOffset) {
    ...
    for (int i = 0; i < iFC; i++) {
        iLen = CAPISocket::Parse_GetShort(
            pDataPack->m_pData,
            iOffset); // 친구 정보.. Send s1(이름길이), str1(유저이름) | Receive s1(이름길이), str1(유저이름), s1(ID), b2(접속, 파티)
...
bool CUIVarious::Load(HANDLE hFile) {
    ...
    m_pBtn_Knights = (CN3UIButton *)(this->GetChildByID("btn_clan"));
    __ASSERT(m_pBtn_Knights, "NULL UI Component!!");
    m_pBtn_State = (CN3UIButton *)(this->GetChildByID("Btn_State"));
    __ASSERT(m_pBtn_State, "NULL UI Component!!");
    m_pBtn_Quest = (CN3UIButton *)(this->GetChildByID("Btn_Quest"));
    __ASSERT(m_pBtn_Quest, "NULL UI Component!!");
    m_pBtn_Friends = (CN3UIButton *)(this->GetChildByID("Btn_Friends"));
    __ASSERT(m_pBtn_Friends, "NULL UI Component!!");
    m_pBtn_Close = (CN3UIButton *)(this->GetChildByID("Btn_Close"));
...
void CUIVarious::UpdatePageButtons(CN3UIButton * pButtonToActive) {
    ...
    if (NULL == pButtonToActive || pButtonToActive == pButtonPrev) {
        return;
    }
...
void CUIVarious::UpdateAllStates(const __InfoPlayerBase * pInfoBase, const __InfoPlayerMySelf * pInfoExt) {
    if (NULL == pInfoBase || NULL == pInfoExt) {
        return;
    }
