...
enum e_Ani {
    ...
    ANI_BLUNT2H_ATTACK_B1, // 양손으로 잡는 둔기. - 양손 도끼와 같다.
    ...
    ANI_SPEAR_BREATH_B,
    ANI_SPEAR_ATTACK_B0,
    ANI_SPEAR_ATTACK_B1, // 창 - 베는 날이 없는 그냥 창이다.
    ...
    ANI_POLEARM_ATTACK_B1, // 양손으로 잡는 날있는 창 - 청룡도 ??
...
const int MAX_ITEM_SLOT_OPC =
    8; // 착용 아이템 - 다른 플레이어(NPC 포함) 0 ~ 4 상체,하체,헬멧,팔,발 5 망토 6 오른손 7 왼손
...
enum e_SkillMagicFailMsg {
    SKILLMAGIC_FAIL_CASTING = -100,    //캐스팅 실패..
