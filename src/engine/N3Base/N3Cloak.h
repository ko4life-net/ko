...
#define CLOAK_SKIP_LINE  2 // Number of lines containing decorative vertices in the cloak. This part does not move. ok?
...
class CN3Cloak : public CN3Base {
  public:
    ...
    class __Particle {
      public:
        __Particle() { memset(this, NULL, sizeof(__Particle)); }
        ~__Particle() {}
  ...
  protected:
    ...
    D3DXVECTOR3  m_GravityForce; // Gravity (.y) must always be present to prevent deformation.
