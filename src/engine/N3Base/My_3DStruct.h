...
struct __ColorValue : public _D3DCOLORVALUE {
  public:
    ...
    D3DCOLOR ToD3DCOLOR() {
        return (((DWORD)(a * 255.0f)) << 24) | (((DWORD)(r * 255.0f)) << 16) | (((DWORD)(g * 255.0f)) << 8) |
               (((DWORD)(b * 255.0f)));
    }
    ...
    D3DCOLORVALUE operator+(float fDelta) {
    ...
    D3DCOLORVALUE operator+(const D3DCOLORVALUE & cv) {
...
struct __VertexColor : public __Vector3 {
  ...
  public:
    void Set(const _D3DVECTOR & p, D3DCOLOR sColor) {
        x = p.x;
        y = p.y;
        z = p.z;
        color = sColor;
...
struct __VertexParticle : public __Vector3 {
  ...
  public:
    void Set(const _D3DVECTOR & p, float fPointSize, D3DCOLOR sColor) {
        x = p.x;
        y = p.y;
        z = p.z;
        color = sColor;
    ...
    __VertexParticle(float sx, float sy, float sz, float fPointSize, D3DCOLOR sColor) {
        this->Set(sx, sy, sz, fPointSize, sColor);
    }
};
...
struct __VertexT2 : public __VertexT1 {
  ...
  public:
    ...
    void Set(float sx, float sy, float sz, float snx, float sny, float snz, float stu, float stv, float stu2,
             float stv2) {
        x = sx;
        y = sy;
        z = sz;
    ...
    __VertexT2() {}
    __VertexT2(const _D3DVECTOR & p, const _D3DVECTOR & n, float u, float v, float u2, float v2) {
        this->Set(p, n, u, v, u2, v2);
    }
    __VertexT2(float sx, float sy, float sz, float snx, float sny, float snz, float stu, float stv, float stu2,
               float stv2) {
...
struct __VertexTransformedT2 : public __VertexTransformed {
  ...
  public:
    ...
    __VertexTransformedT2(float sx, float sy, float sz, float srhw, D3DCOLOR sColor, float stu, float stv, float stu2,
                          float stv2) {
...
struct __VertexXyzT1 : public __Vector3 {
  ...
  public:
    void Set(const _D3DVECTOR & p, float u, float v) {
        x = p.x;
        y = p.y;
        z = p.z;
        tu = u;
...
struct __VertexXyzT2 : public __VertexXyzT1 {
  ...
  public:
    void Set(const _D3DVECTOR & p, float u, float v, float u2, float v2) {
        x = p.x;
        y = p.y;
        z = p.z;
        tu = u;
...
struct __VertexXyzNormal : public __Vector3 {
  ...
  public:
    void Set(const _D3DVECTOR & p, const _D3DVECTOR & sn) {
        x = p.x;
        y = p.y;
        z = p.z;
        n = sn;
...
struct __VertexXyzColorSpecularT1 : public __Vector3 {
  ...
  public:
    void Set(const _D3DVECTOR & p, D3DCOLOR sColor, D3DCOLOR sSpecular, float u, float v) {
        x = p.x;
        y = p.y;
        z = p.z;
        color = sColor;
        specular = sSpecular, tu = u;
        tv = v;
    }
    ...
    __VertexXyzColorSpecularT1(const _D3DVECTOR & p, D3DCOLOR sColor, D3DCOLOR sSpecular, float u, float v) {
        this->Set(p, sColor, sSpecular, u, v);
    }
    __VertexXyzColorSpecularT1(float sx, float sy, float sz, D3DCOLOR sColor, D3DCOLOR sSpecular, float u, float v) {
        this->Set(sx, sy, sz, sColor, sSpecular, u, v);
    }
};
...
struct __VertexXyzColorT1 : public __Vector3 {
  ...
  public:
    void Set(const _D3DVECTOR & p, D3DCOLOR sColor, float u, float v) {
        x = p.x;
        y = p.y;
        z = p.z;
        color = sColor;
...
struct __VertexXyzColorT2 : public __VertexXyzColorT1 {
  ...
  public:
    void Set(const _D3DVECTOR & p, D3DCOLOR sColor, float u, float v, float u2, float v2) {
        x = p.x;
        y = p.y;
        z = p.z;
        color = sColor;
    ...
    __VertexXyzColorT2() {}
    __VertexXyzColorT2(const _D3DVECTOR & p, D3DCOLOR sColor, float u, float v, float u2, float v2) {
        this->Set(p, sColor, u, v, u2, v2);
    }
    __VertexXyzColorT2(float sx, float sy, float sz, D3DCOLOR sColor, float u, float v, float u2, float v2) {
        this->Set(sx, sy, sz, sColor, u, v, u2, v2);
    }
};
...
struct __VertexXyzNormalColor : public __Vector3 {
  ...
  public:
    void Set(const _D3DVECTOR & p, const _D3DVECTOR & sn, D3DCOLOR sColor) {
        x = p.x;
        y = p.y;
        z = p.z;
        n = sn;
    ...
    __VertexXyzNormalColor(float sx, float sy, float sz, float xx, float yy, float zz, D3DCOLOR sColor) {
        this->Set(sx, sy, sz, xx, yy, zz, sColor);
    }
};
...
bool  _IntersectTriangle(const __Vector3 & vOrig, const __Vector3 & vDir, const __Vector3 & v0, const __Vector3 & v1,
                         const __Vector3 & v2, float & fT, float & fU, float & fV, __Vector3 * pVCol = NULL);
bool  _IntersectTriangle(const __Vector3 & vOrig, const __Vector3 & vDir, const __Vector3 & v0, const __Vector3 & v1,
                         const __Vector3 & v2);
bool  _CheckCollisionByBox(const __Vector3 & vOrig, const __Vector3 & vDir, const __Vector3 & vMin,
                           const __Vector3 & vMax);
POINT _Convert3D_To_2DCoordinate(const __Vector3 & vPos, const __Matrix44 & mtxView, const __Matrix44 & mtxProjection,
                                 int nVPW, int nVPH);
void  _Convert2D_To_3DCoordinate(int ixScreen, int iyScreen, const __Matrix44 & mtxView, const __Matrix44 & mtxPrj,
...
inline bool _CheckCollisionByBox(const __Vector3 & vOrig, const __Vector3 & vDir, const __Vector3 & vMin,
                                 const __Vector3 & vMax) {
...
inline bool _IntersectTriangle(const __Vector3 & vOrig, const __Vector3 & vDir, const __Vector3 & v0,
...
inline POINT _Convert3D_To_2DCoordinate(const __Vector3 & vPos, const __Matrix44 & mtxView,
                                        const __Matrix44 & mtxProjection, int nVPW, int nVPH) {
    __Matrix44 matVP;
...
inline void _Convert2D_To_3DCoordinate(int ixScreen, int iyScreen, const __Matrix44 & mtxView,
                                       const __Matrix44 & mtxPrj, const D3DVIEWPORT9 & vp, __Vector3 & vPosResult,
...
inline float _Yaw2D(float fDirX, float fDirZ) {
    ...
    if (fDirX >= 0.0f) // ^^
    {
        if (fDirZ >= 0.0f) {
            ...
            return (D3DXToRadian(90.0f) + (float)(acos(fDirX)));
        }
    } else {
        if (fDirZ >= 0.0f) {
            return (D3DXToRadian(270.0f) + (float)(acos(-fDirX)));
        } else {
...
inline short int _IsKeyDown(int iVirtualKey) {
    return (GetAsyncKeyState(iVirtualKey) & 0xff00);
}
inline short int _IsKeyDowned(int iVirtualKey) {
...
template <class T> const T T_Min(const T a, const T b) {
    return ((a > b) ? a : b);
}
template <class T> const T T_Abs(const T a) {
    return ((a > 0) ? a : -a);
}

template <class T> void T_Delete(T *& ptr) {
    delete ptr;
    ptr = NULL;
} // Template Delete Pointer
template <class T> void T_DeleteArray(T *& ptr) {
    delete[] ptr;
    ptr = NULL;
} // Template Delete Pointer
template <class T> void T_Tick(T & obj) {
    obj.Tick();
} // Template Delete Pointer
template <class T> void T_Render(T & obj) {
    obj.Render();
} // Template Delete Pointer
