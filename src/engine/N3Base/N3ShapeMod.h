...
class CN3ShapeMod : public CN3Shape {
  ...
  protected:
    ...
    __ModPart **
        m_pMatchPart2ModPart; // CPart리스트 배열순으로 __ModPart*와 매치시킨 배열 (load시 CPart 갯수만큼 배열로 잡고 정보를 넣는다)
  ...
  protected:
    CN3SPart * GetPartByPMeshFileName(const fs::path & fsFile); // 이름으로 PMesh포인터 구하기
};
