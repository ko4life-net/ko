...
CPortalWall::CPortalWall(e_WallType eWT, CPortalVol * pVol) {
    ...
    if (pVol) {
        switch (m_eWallType) {
        case WALL_ZB:
            m_pvVertex[0].Set(-fBaseWallSize + fWallSizeOffset, fBaseWallSize - fWallSizeOffset, fBaseWallSize,
                              dwColorNoneAlpha);
            m_pvVertex[1].Set(-fBaseWallSize + fWallSizeOffset, -fBaseWallSize + fWallSizeOffset, fBaseWallSize,
                              dwColorNoneAlpha);
            m_pvVertex[2].Set(fBaseWallSize - fWallSizeOffset, fBaseWallSize - fWallSizeOffset, fBaseWallSize,
                              dwColorNoneAlpha);
            m_pvVertex[3].Set(fBaseWallSize - fWallSizeOffset, -fBaseWallSize + fWallSizeOffset, fBaseWallSize,
                              dwColorNoneAlpha);
            break;
        ...
        case WALL_XL:
            m_pvVertex[0].Set(-fBaseWallSize, fBaseWallSize - fWallSizeOffset, fBaseWallSize - fWallSizeOffset,
                              dwColorNoneAlpha);
            m_pvVertex[1].Set(-fBaseWallSize, -fBaseWallSize + fWallSizeOffset, fBaseWallSize - fWallSizeOffset,
                              dwColorNoneAlpha);
            m_pvVertex[2].Set(-fBaseWallSize, fBaseWallSize - fWallSizeOffset, -fBaseWallSize + fWallSizeOffset,
                              dwColorNoneAlpha);
            m_pvVertex[3].Set(-fBaseWallSize, -fBaseWallSize + fWallSizeOffset, -fBaseWallSize + fWallSizeOffset,
                              dwColorNoneAlpha);
            break;
        ...
        case WALL_YB:
            m_pvVertex[0].Set(-fBaseWallSize + fWallSizeOffset, -fBaseWallSize, fBaseWallSize - fWallSizeOffset,
                              dwColorNoneAlpha);
            m_pvVertex[1].Set(fBaseWallSize - fWallSizeOffset, -fBaseWallSize, fBaseWallSize - fWallSizeOffset,
                              dwColorNoneAlpha);
            m_pvVertex[2].Set(-fBaseWallSize + fWallSizeOffset, -fBaseWallSize, -fBaseWallSize + fWallSizeOffset,
                              dwColorNoneAlpha);
            m_pvVertex[3].Set(fBaseWallSize - fWallSizeOffset, -fBaseWallSize, -fBaseWallSize + fWallSizeOffset,
                              dwColorNoneAlpha);
            break;
...
void CPortalWall::Translate() {
    ...
    for (int i = 0; i < 4; i++) {
        vec[i] *= m_MtxScale;
        vec[i] *= m_MtxMove;
        m_pvVertex[i].x = vec[i].x;
        m_pvVertex[i].y = vec[i].y;
        m_pvVertex[i].z = vec[i].z;
...
void CPortalWall::RenderEdit() {
    ...
    CN3Base::s_lpD3DDev->DrawIndexedPrimitiveUP(D3DPT_TRIANGLELIST, 0, 4, 2, m_pIndex, D3DFMT_INDEX16, m_pvVertex,
