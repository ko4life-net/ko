...
void CShapeTypeDlg::OnRadioPartial() {
    ...
    CButton * pBut = (CButton *)GetDlgItem(IDC_RADIO_PARTIAL);
    pBut->SetCheck(1);
    pBut = (CButton *)GetDlgItem(IDC_RADIO_NONEPARTIAL);
    pBut->SetCheck(0);
}
...
BOOL CShapeTypeDlg::OnInitDialog() {
    ...
    MoveWindow((rect2.left + rect2.right) / 2 - iWidth, (rect2.bottom + rect2.top) / 2 - iHeight, iWidth * 2,
               iHeight * 2);
