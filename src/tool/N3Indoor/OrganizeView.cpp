...
void COrganizeView::InitEnvironSetting() {
    CButton * pBut = (CButton *)GetDlgItem(IDC_EDIT);
    pBut->SetCheck(1);
    pBut = (CButton *)GetDlgItem(IDC_STATE_PVOLUMN);
    pBut->SetCheck(1);
    ...
    pBut = (CButton *)GetDlgItem(IDC_ADD_SHAPE);
    pBut->SetCheck(1);
}
...
void COrganizeView::OnEdit() {
    CButton * pBut = (CButton *)GetDlgItem(IDC_EDIT);
    pBut->SetCheck(1);
    pBut = (CButton *)GetDlgItem(IDC_COMPILE);
    pBut->SetCheck(0);
    pBut = (CButton *)GetDlgItem(IDC_ACTIVE);
    pBut->SetCheck(0);

    pBut = (CButton *)GetDlgItem(IDC_BTN_CREATE_VOL);
    pBut->EnableWindow(1);
    pBut = (CButton *)GetDlgItem(IDC_BTN_DELETE);
    pBut->EnableWindow(1);
    pBut = (CButton *)GetDlgItem(IDC_BTN_CREATE_GATE1);
    pBut->EnableWindow(1);
    pBut = (CButton *)GetDlgItem(IDC_BTN_CREATE_GATE2);
    pBut->EnableWindow(1);
    pBut = (CButton *)GetDlgItem(IDC_BTN_CREATE_GATE3);
    pBut->EnableWindow(1);
    pBut = (CButton *)GetDlgItem(IDC_BTN_CREATE_GATE4);
    pBut->EnableWindow(1);
    pBut = (CButton *)GetDlgItem(IDC_BTN_CREATE_GATE5);
    pBut->EnableWindow(1);
    pBut = (CButton *)GetDlgItem(IDC_BTN_CREATE_GATE6);
    pBut->EnableWindow(1);
    pBut = (CButton *)GetDlgItem(IDC_BTN_LINKED_DELETE);
    pBut->EnableWindow(1);
    pBut = (CButton *)GetDlgItem(IDC_BTN_SHAPE_DELETE);
    pBut->EnableWindow(1);
...
void COrganizeView::OnActive() {
    ...
    pBut = (CButton *)GetDlgItem(IDC_EDIT);
    pBut->SetCheck(0);
    pBut = (CButton *)GetDlgItem(IDC_COMPILE);
    pBut->SetCheck(0);
    pBut = (CButton *)GetDlgItem(IDC_ACTIVE);
...
void COrganizeView::OnStatePvolumn() {
    ...
    CButton * pBut = (CButton *)GetDlgItem(IDC_STATE_PVOLUMN);
    pBut->SetCheck(1);
    pBut = (CButton *)GetDlgItem(IDC_STATE_SHAPE);
    pBut->SetCheck(0);
    pBut = (CButton *)GetDlgItem(IDC_INDI_ROTATE);
    pBut->EnableWindow(0);
    pBut->SetCheck(0);
    ...
    for (int i = 0; i < iSize; i++) {
        ...
        while (siit != pVol->m_plShapeInfoList.end()) {
            ...
            if (pSI->m_iEventID || pSI->m_iEventType || pSI->m_iNPC_ID || pSI->m_iNPC_Status) // 이벤트가 있으면
            {
                ...
                sEvent = (short)(pSI->m_iEventID);
                WriteFile(hFile, &sEvent, 2, &dwNum, NULL);
                sEvent = (short)(pSI->m_iEventType);
                WriteFile(hFile, &sEvent, 2, &dwNum, NULL);
                sEvent = (short)(pSI->m_iNPC_ID);
                WriteFile(hFile, &sEvent, 2, &dwNum, NULL);
                sEvent = (short)(pSI->m_iNPC_Status);
                WriteFile(hFile, &sEvent, 2, &dwNum, NULL);
