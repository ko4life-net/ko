...
LINK32=link.exe
LINK32_FLAGS=winmm.lib d3d9.lib d3dx9.lib dsound.lib dxguid.lib strmiids.lib  /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\N3FXE_Debug.pdb" /debug /machine:I386 /out:"N3FXE_Debug.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\N3FXE.obj" \
	"$(INTDIR)\StdAfx.obj" \
	"$(INTDIR)\BitMapFile.obj" \
