# Microsoft Developer Studio Project File - Name="N3CE" - Package Owner=<4>
...
# PROP Scc_ProjName ""$/N3CE", GRAAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# ADD LINK32 d3d8.lib d3dx8.lib dsound.lib dxerr8.lib dxguid.lib winmm.lib /nologo /subsystem:windows /machine:I386 /force /out:"N3CE.exe"
...
# ADD LINK32 d3d8.lib d3dx8.lib dsound.lib dxerr8.lib dxguid.lib winmm.lib /nologo /subsystem:windows /debug /machine:I386 /out:"N3CE_Debug.exe" /pdbtype:sept

!ENDIF 

# Begin Target

# Name "N3CE - Win32 Release"
# Name "N3CE - Win32 Debug"
...
SOURCE=.\FormViewTool.h
# End Source File
# Begin Source File

SOURCE=.\MacSliderCtrl.h
# End Source File
# Begin Source File
