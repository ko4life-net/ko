...
# ADD LINK32 d3d9.lib d3dx9.lib dsound.lib dxguid.lib winmm.lib /nologo /subsystem:windows /machine:I386 /force /out:"N3CE.exe"
...
# ADD LINK32 d3d9.lib d3dx9d.lib dsound.lib dxguidd.lib winmm.lib /nologo /subsystem:windows /debug /machine:I386 /out:"N3CE_Debug.exe" /pdbtype:sept
