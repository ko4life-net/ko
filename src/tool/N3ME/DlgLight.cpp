...
void CDlgLight::OnBtnExport() {
    if (m_strPathName.IsEmpty()) {
        CFileDialog dlg(FALSE, "LightObjs", "Noname", OFN_EXPLORER | OFN_LONGNAMES | OFN_OVERWRITEPROMPT,
                        "Light Obejct Data File(*.LightObjs)|*.LightObjs||");
