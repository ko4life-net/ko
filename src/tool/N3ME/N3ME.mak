...
LINK32=link.exe
LINK32_FLAGS=d3d9.lib d3dx9.lib dxerr.lib dsound.lib dxguid.lib winmm.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\N3ME.pdb" /map:"$(INTDIR)\N3ME.map" /machine:I386 /force /out:"N3ME.exe" /opt:ref 
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=d3d9.lib d3dx9.lib dxerr.lib dsound.lib dxguid.lib winmm.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\N3ME_debug.pdb" /map:"$(INTDIR)\N3ME_debug.map" /debug /machine:I386 /force /out:"N3ME_debug.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\BitMapFile.obj" \
	"$(INTDIR)\LogWriter.obj" \
	"$(INTDIR)\N3AlphaPrimitiveManager.obj" \
