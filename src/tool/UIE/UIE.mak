...
LINK32=link.exe
LINK32_FLAGS=d3d9.lib d3dx9.lib dsound.lib dxguid.lib winmm.lib /nologo /subsystem:windows /incremental:yes /pdb:"$(OUTDIR)\UIE_Debug.pdb" /debug /machine:I386 /out:"UIE_Debug.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\DlgChangeImage.obj" \
	"$(INTDIR)\DlgUnusedFileList.obj" \
	"$(INTDIR)\HierarchyView.obj" \
