...
class CDBAgent {
  public:
    ...
    BOOL SetLogInInfo(const char * accountid, const char * charid, const char * serverip, int serverno,
    ...
    int  CreateNewChar(char * accountid, int index, char * charid, int race, int Class, int hair, int face, int str,
                       int sta, int dex, int intel, int cha);
