...
void CNpcTableSet::DoFieldExchange(CFieldExchange* pFX)
{
	...
	RFX_Int(pFX, _T("[sHpPoint]"), m_iHpPoint);
	...
	RFX_Int(pFX, _T("[byFireR]"), m_byFireR);
	RFX_Int(pFX, _T("[byColdR]"), m_byColdR);
	RFX_Int(pFX, _T("[byLightningR]"), m_byLightningR);
	RFX_Int(pFX, _T("[byMagicR]"), m_byMagicR);
	RFX_Int(pFX, _T("[byDiseaseR]"), m_byDiseaseR);
	RFX_Int(pFX, _T("[byPoisonR]"), m_byPoisonR);
	RFX_Int(pFX, _T("[byLightR]"), m_byLightR);
