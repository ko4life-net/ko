...
class CMagicProcess {
  ...
  public:
    ...
    void  ExecuteType3(int magicid, int tid, int data1, int data2, int data3, int moral, int dexpoint,
                       int righthand_damage);
    BYTE  ExecuteType2(int magicid, int tid, int data1, int data2, int data3);
    BYTE  ExecuteType1(int magicid, int tid, int data1, int data2, int data3,
                       BYTE sequence); // sequence => type1 or type2
    short GetMagicDamage(int tid, int total_hit, int attribute, int dexpoint, int righthand_damage);
    short AreaAttack(int magictype, int magicid, int moral, int data1, int data2, int data3, int dexpoint,
                     int righthand_damage);
    void  AreaAttackDamage(int magictype, int rx, int rz, int magicid, int moral, int data1, int data2, int data3,
